    ...
    <section className="relative z-10 w-full min-h-screen flex items-center">
      ...
      <div className="w-full max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 xl:px-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          {/* RIGHT */}
          <div className="flex justify-center items-center mt-10 lg:mt-0 order-1 lg:order-2">
            <img
              src={HomeGif}
              alt="Hero Animation"
              className="w-full max-w-[300px] sm:max-w-[400px] md:max-w-[450px] lg:max-w-[500px] rounded-2xl shadow-2xl"
            />
          </div>
