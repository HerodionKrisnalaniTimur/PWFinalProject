...
import pomini from "../../assets/Pomni-Default.webp";
declare global {
  interface Window { 
    ethereum?: any;
  }
...
const rewardItems = [
  ...
  { id: 8, studio: "Digital Happiness", itemName: "DreadOut - Official Linda Bag - Bag Linda", price: 1000, img: lindaBag, tag: "Merch" },
  { id: 9, studio: "Gooseworx", itemName: "Glitch Productions - Pomni_UwU"},
];
