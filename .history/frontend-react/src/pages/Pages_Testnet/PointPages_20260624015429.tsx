...
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                    <div key={item.id} className="bg-white rounded-[24px] p-4 flex flex-col shadow-sm border border-gray-100 hover:shadow-lg transition-shadow">
                      ...
                      {/* 2. Pindahkan 'onClick' ke Kotak Gambar agar hanya area ini yang bisa diklik */}
                      <div 
                      ...
                      >
                        {/* 3. Ganti 'group-hover' menjadi 'hover' agar gambar hanya membesar saat disorot langsung */}
                      ...
                      <div className="mt-4 mb-5 flex justify-between items-start gap-3 flex-1 px-1">
                        ...
                        <div className="flex flex-col flex-1">
                          {/* 4. Jadikan teks judul bisa diklik dan hanya berubah warna saat disorot langsung */}
                          <h4 
                            onClick={() => openItemDetail(item)}
...
{/* Grid Produk */}
                ...
                </div>                    <div key={item.id} onClick={() => openItemDetail(item)} className="bg-white rounded-[24px] p-4 flex flex-col shadow-sm border border-gray-100 group cursor-pointer hover:shadow-lg transition-shadow">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                      <div className="relative w-full aspect-square rounded-[16px] overflow-hidden bg-[#F8F9FA] border border-gray-100 flex items-center justify-center">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                        <img src={item.img} alt={item.itemName} className="w-full h-full object-contain p-2 group-hover:scale-105 transition-transform duration-500" />
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                        {/* Tag Promo (Pindah ke kiri bawah gambar) */}
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                          <div className="absolute bottom-3 left-3 bg-[#D43D9D] text-white text-[10px] font-bold px-3 py-1 rounded shadow-sm uppercase tracking-wider">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                      {/* Detail Teks (Nama di Kiri, Harga di Kanan) */}
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                      <div className="mt-4 mb-5 flex justify-between items-start gap-3 flex-1 px-1">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                          <h4 className="font-bold text-gray-800 text-[14px] leading-tight mb-1 group-hover:text-[#27BDE2] transition-colors pr-2">{item.itemName}</h4>
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                          <span className="text-[10px] text-gray-400 font-medium tracking-wide uppercase">{item.studio}</span>
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                        <div className="flex flex-col items-end text-right shrink-0">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                            <span className="text-gray-400 line-through text-[10px] font-bold mb-0.5">{item.oldPrice.toLocaleString()} PTS</span>
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                          <div className="flex flex-col items-end leading-none">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                            <span className="text-[#27BDE2] font-black text-lg">{item.price.toLocaleString()}</span>
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                            <span className="text-[#27BDE2] text-[9px] font-bold uppercase mt-1">PTS</span>
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
...
{/* Grid Produk */}
                ...
                </div>                      {/* Tombol Add to Cart (Rounded penuh dengan Ikon) */}
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
                ...
                </div>                      <button onClick={(e) => { e.stopPropagation(); openItemDetail(item); }} className="w-full bg-[#27BDE2] hover:bg-[#1E9EBD] text-white font-bold py-3.5 px-4 rounded-[14px] text-[12px] transition-colors flex items-center justify-center gap-2 uppercase tracking-wider">
{/* Grid Produk */}
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                  {rewardItems.map((item) => (
                    // 1. Hapus 'group', 'cursor-pointer', dan 'onClick' dari bungkus luar
