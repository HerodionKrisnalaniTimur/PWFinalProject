...
export default function Blog() {
  ...
  return (
    <section className="relative py-12 sm:py-16 text-white overflow-hidden bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900">
      ...
      {/* GRID */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.05] bg-[linear-gradient(to_right,white_1px,transparent_1px),linear-gradient(to_bottom,white_1px,transparent_1px)] bg-[size:40px_40px]" />

      {/* GLOW */}
      <div className="absolute top-[-100px] left-[-100px] w-[300px] h-[300px] bg-blue-400/30 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-100px] right-[-100px] w-[300px] h-[300px] bg-purple-500/30 rounded-full blur-[120px] pointer-events-none" />
