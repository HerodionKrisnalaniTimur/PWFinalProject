...
export default function Blog() {
  ...
  return (
    <section className="relative bg-gradient-to-b from-blue-700 via-blue-800 to-blue-900 overflow-hidden">

      {/* BACKGROUND (non-interactive) */}
      <div className="absolute inset-0 pointer-events-none opacity-[0.05] bg-[linear-gradient(...)]" />
      <div className="absolute top-[-100px] left-[-100px] w-[300px] h-[300px] bg-blue-400/30 blur-[120px] pointer-events-none" />
